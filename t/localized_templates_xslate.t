...
ok( $tmpl->isa('Chronicle::Template::XslateTT'),
    "Got a Chronicle::Template::XslateTT object" );
$tmpl->param( foo => 1 );
...
ok( $tmpl->isa('Chronicle::Template::XslateTT'),
    "Got a Chronicle::Template::XslateTT object for de_DE" );
$tmpl->param( foo => 1 );
